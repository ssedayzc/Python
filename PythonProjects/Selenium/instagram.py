...
class Instagram:
    ...
    def signIn(self):
        self.browser.get("https://z-p15.www.instagram.com/accounts/login/")
        time.sleep(3)
    ...
    def getFollowers(self, max):
        ...
        time.sleep(2)
        self.browser.find_element_by_xpath("//*[@id='react-root']/section/main/div/ul/li[2]/a/div/span").click()
        time.sleep(2)
